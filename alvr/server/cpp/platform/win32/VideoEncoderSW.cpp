...
void VideoEncoderSW::Transmit(ID3D11Texture2D *pTexture, uint64_t presentationTime, uint64_t targetTimestampNs, bool insertIDR, int leftxIn, int leftyIn, int rightxIn, int rightyIn,float header_centerShiftX, float header_centerShiftY) {
